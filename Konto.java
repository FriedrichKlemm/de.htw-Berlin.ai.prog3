...
public abstract class Konto implements Comparable<Konto>
{
    ...
    public void waehrungswechsel(Waehrung neu) {
        this.waehrung = neu;
        this.kontostand = this.kontostand * this.waehrung; //TODO umrechner
    }
	...
	public boolean abheben(double betrag, Waehrung w) throws GesperrtException {
	    if (gesperrt) {
	        ...
	        if (this.waehrung == w) {
	            ...
	            this.kontostand = kontostand - w.waehrungInEuroUmrechnen(betrag);
            }
            else if (w == Waehrung.EUR) {
	            this.kontostand = kontostand - w.euroInWaehrungUmrechnen(betrag);
            }
            return true;
        }
    }
